...
const ПОДПИСИ = {
  ...
  'pop-hover': 'главная под рукой', 'pop-trail-near': 'хвост главной: ближний тон', 'pop-trail-far': 'хвост главной: дальний тон', 'pop-grad': 'градиент главной: второй конец', 'edge-off': 'кромка выключенной',
}
