...
export const REQUIRED = {
  ...
  '--quiet-pop': 'тихая плашка на заливке кнопки — счётчик «в корзине: 2» на кнопке покупки; первый читатель — магазин (cbdin, BuyBtn; И446)',
  '--on-quiet-pop': 'надпись на тихой плашке заливки — число счётчика на кнопке покупки (И446)',
