...
const ROLE = [
  ...
  /* Карта товара — ручки вида галереи (И271): доля ряда, пропорция снимка,
     место миниатюр. Роли, а не узлы: их ставит вид сайта на корне (панель
     «Look»), читает узел `gallery` карты. Список закрытый — по имени. */
  { rx: /^--pdp-(gallery|frame|thumbs)$/, family: 'карта товара: вид галереи', by: 'templates/storefront/styles/storefront.css' },
]
