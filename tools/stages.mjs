...
export const STAGES = [
  {
    ...
    steps: [
      ...
      step(7, 'Размер узлов', 'три размера — малый, средний, крупный — ролями из порогов; под пальцем ступень выше; орган считает всё от высоты', 'scale',
        ...
        { reviewed: '20.09.2026', rule: 'И226: три размера из порогов, под пальцем ступень выше, орган считает от высоты', show: 'npm run control:stand — три размера на одной карточке' }),
