...
| Admin | Home | Layout | состав главной (`home`): порядок блоков и раскладка каждого; слова, снимки, протокол и способы доставки — данные страницы, одни на все варианты (бриф — `docs/design/home.md` набора) | Scene (умолчание), Shop first, Lab report first, Headline first, Cabinet, Showroom |
