...
2. **Выбор.** Панель на витрине (`LOOK_PICKER=on`), вход — язычок «Look» на
   правом краю окна, в поле страницы: ни текста, ни органа он не закрывает,
   на телефоне это черта-ручка (И344). Раздел —
