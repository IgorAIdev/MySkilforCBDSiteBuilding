...
export type Group = 'palette' | 'scale' | 'width' | 'corners' | 'shadow' | 'face' | 'button' | 'marker' | 'field' | 'field-label' | 'tick' | 'pdp-gallery' | 'pdp-thumbs' | 'pdp-edge' | 'seg-look' | 'go-hover' | 'head-icons' | 'say-look' | 'pair-look' | 'chip-sign' | 'shot-frame' | 'shelf-cols' | 'card-buy' | 'sort-label'
...
const WORDS: Readonly<Record<SlotType, readonly string[]>> = {
  ...
  length: ['normal'],
  number: [],
  keyword: ['none', 'uppercase', 'lowercase', 'capitalize', 'normal', 'underline', 'block', 'below', 'side', 'dots', 'over', 'inset', 'bleed', 'full', 'beside', 'above', 'edge', 'inside', 'chips', 'joined', 'tray', 'bare', 'toned', 'line', 'note', 'apart', 'joined', 'show'],
...
const FIELDS = new Set(['palette', 'face', 'scale', 'width', 'corners', 'shadow', 'marker', 'field', 'field-label', 'tick', 'header', 'card', 'home', 'pdp-gallery', 'pdp-thumbs', 'pdp-edge', 'seg-look', 'go-hover', 'head-icons', 'say-look', 'pair-look', 'chip-sign', 'shot-frame', 'shelf-cols', 'card-buy', 'sort-label'])
