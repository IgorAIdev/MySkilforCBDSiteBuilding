...
export const EN: Record<keyof typeof RO, string> = {
  ...
  'lab.lab': 'Laboratory',
  'lab.date': 'Test date',
  'facts.label': 'Key figures',
  'facts.total': 'CBD in total',
  'facts.perMl': 'CBD in 1 ml',
  'facts.perG': 'CBD in 1 g',
  'facts.perPiece': 'CBD in one piece',
  'facts.perDrop': 'CBD in one drop',
  'facts.drops': '≈ {n} drops in the bottle',
  'facts.perMg': 'for 1 mg of CBD',
  ...
  'quick.open': 'Quick order',
  'quick.lead': 'Order with one message in your favourite messenger — we will confirm delivery and payment in a minute.',
  'quick.close': 'Close',
  'quick.via': 'Order via {name}',
  'quick.greet': 'Hello! I would like to order:',
  'quick.qty': 'pcs',
  'quick.myPhone': 'My phone',
  'quick.phone': 'Or leave your phone',
  'quick.call': 'Call me back',
