...
export const HU: Record<keyof typeof RO, string> = {
  ...
  'facts.label': 'Fő adatok',
  'facts.total': 'CBD összesen',
  'facts.perMl': 'CBD 1 ml-ben',
  'facts.perG': 'CBD 1 g-ban',
  'facts.perPiece': 'CBD egy darabban',
  'facts.perDrop': 'CBD egy cseppben',
  'facts.drops': '≈ {n} csepp az üvegben',
  'facts.perMg': '1 mg CBD ára',
  ...
  'quick.open': 'Gyors rendelés',
  'quick.lead': 'Rendeljen egyetlen üzenettel a kedvenc üzenetküldőjében — a szállítást és a fizetést egy percen belül visszaigazoljuk.',
  'quick.close': 'Bezárás',
  'quick.via': 'Rendelés: {name}',
  'quick.greet': 'Jó napot! Szeretném megrendelni:',
  'quick.qty': 'db',
  'quick.myPhone': 'A telefonszámom',
  'quick.phone': 'Vagy hagyja meg telefonszámát',
  'quick.call': 'Hívjanak vissza',
