...
export const ORDER: readonly Group[] = ['palette', 'scale', 'width', 'corners', 'shadow', 'face', 'marker', 'field', 'field-label', 'tick', 'button', 'pdp-gallery', 'pdp-thumbs', 'pdp-edge', 'seg-look', 'go-hover', 'head-icons', 'say-look', 'shot-frame', 'shelf-cols', 'card-buy', 'sort-label']
